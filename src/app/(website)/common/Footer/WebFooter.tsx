        ...
        <MaxWidthWrapper className="px-4">
          ...
          <div className="mx-auto grid grid-cols-1 gap-5 border-t pt-6 md:grid-cols-12">
            ...
            <div className="col-span-12 md:col-span-3 lg:col-span-2">
              <h3 className="text-md lg:text-md relative font-nunito font-semibold tracking-wide text-white after:absolute after:bottom-[-5px] after:left-0 after:h-0.5 after:w-16 after:bg-[#FB9100] after:content-['']">
                Useful Links
              </h3>
              <ul
                className={cn(
            ...
            <div className="col-span-12 mt-6 lg:hidden">
              <h3 className="lg:text-md font-nunito text-lg font-semibold tracking-wide text-white">
                Follow Us
              </h3>
              <div className="mt-4 flex gap-2">
                <Link
